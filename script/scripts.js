...
$(".busy").parallax({
  imageSrc: "./img/parallax/build-background.webp",
  speed: 0.1,
});
...
$(".customers__content-items-flex").on("click", function () {
  $(this)
    .parent(".customers__content-items")
    .toggleClass("customers__content-items-toggle");
  $(this)
    .children(".customers__content-item-title")
    .toggleClass("customers__content-item-title-toggle");
  $(this)
    .children(".customers__content-svg")
    .children("path")
    .toggleClass("customers__content-blue-img");
  $(this).next("p").slideToggle(400);
});
...
$("#home").on("click", function (e) {
  ...
  $("html, body").animate(
    { scrollTop: $("#manage").offset().top - headerHeight },
    500
  );
...
$("#stories").on("click", function (e) {
  ...
  let headerHeight = $(".header").height();
  $("html, body").animate(
    { scrollTop: $("#understand").offset().top - headerHeight },
    500
  );
  document.getElementById("checkbox").checked = false;
});
